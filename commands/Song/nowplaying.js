...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    if(player && channel.id !== player.voiceChannel)
      return message.channel.send(`**:x: You need to be in the same voice channel as Billi to use this command**`);
    //Send Information Message
    message.channel.send(new MessageEmbed()
      .setAuthor("Now Playing ♪", client.user.displayAvatarURL(), "https://discord.gg/m4T9HE6dCu")
