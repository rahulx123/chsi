...
module.exports = async (client, message, args, type, channel, guild) => {
  ...
  if (method[0] === "play")
    ...
    return message.channel.send(new MessageEmbed()
      ...
      .setTitle("❌ Error | No valid search Term? ... Please Contact: `skittle`")
    );
}
...
const search = args.join(" ");
  ...
  if(message.guild.me.permissionsIn(message.channel).has("EMBED_LINKS")){
    ...
    .setAuthor(message.author.username, message.author.displayAvatarURL({dynamic: true}), "https://discord.gg/ZZ7H9TdjYP")
    .setColor(ee.color)
    ...
    message.channel.awaitMessages(m => m.author.id == message.author.id, {
      ...
      if (index < 0 || index > max - 1) return waitforanswer();
        ...
        let playembed = new Discord.MessageEmbed()
          .setAuthor(`Added to queue`, message.author.displayAvatarURL({dynamic: true}), "https://discord.gg/ZZ7H9TdjYP")
          .setURL(track.uri)
    ...
    function playlist_() {
      ...
      var time = 0;
        let playlistembed = new Discord.MessageEmbed()
          ...
          .setAuthor(`Playlist added to Queue`, message.author.displayAvatarURL({dynamic:true}), "https://discord.gg/ZZ7H9TdjYP" )
          .setColor(ee.color)
